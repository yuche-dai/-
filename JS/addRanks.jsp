...
<div class="konbaiweizi">
    <p align="center">新增天梯排行</p>
    <form id="form1" name="form1" method="post"   action="Ranks99?method=3">
        <table align="center" width="260" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><input type="text" name="konlon" id="textfield2"/></td>
            </tr>
            <tr>
                <th scope="row" >战力：</th>
                <td><input type="text" name="powers" id="textfield3"/></td>
            </tr>
            <tr>
                <th scope="row" >排名：</th>
                <td><input type="text" name="ranking" id="textfield4"/></td>
            </tr>
            <tr>
